...
class SidebarStartupDelayTests(unittest.TestCase):
    ...
    def test_sidebar_search_and_hidden_mode_items_stay_after_initial_paint_but_not_late(self) -> None:
        ...
        self.assertGreaterEqual(sidebar_builder.SIDEBAR_SEARCH_AFTER_INTERACTIVE_MS, 400)
        self.assertLessEqual(sidebar_builder.SIDEBAR_SEARCH_AFTER_INTERACTIVE_MS, 500)
        self.assertGreaterEqual(sidebar_builder.SIDEBAR_HIDDEN_MODE_ITEMS_AFTER_INTERACTIVE_MS, 1_000)
        self.assertLessEqual(sidebar_builder.SIDEBAR_HIDDEN_MODE_ITEMS_AFTER_INTERACTIVE_MS, 1_200)
