...
Мы ввели понятие [пресетов](https://publish.obsidian.md/zapret/Privacy/Zapret2/preset) и их настроек. А также написали несколько своих `lua` стратегий которые успешно обходят блокировки.
