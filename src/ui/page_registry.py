...
PAGE_PERFORMANCE_PROFILES: dict[PageName, PagePerformanceProfile] = {
    ...
    PageName.ZAPRET2_ORCHESTRA: _profile("heavy_list", 200),
    PageName.ZAPRET2_ORCHESTRA_CONTROL: _profile("heavy_list", 200),
    PageName.ZAPRET2_ORCHESTRA_USER_PRESETS: _profile("heavy_list", 200),
    PageName.ZAPRET2_ORCHESTRA_STRATEGY_DETAIL: _profile("heavy_list", 200),
    PageName.ZAPRET2_ORCHESTRA_PRESET_DETAIL: _profile("heavy_list", 200),
