...
_PAGE_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "Zapret2PresetDetailPage": ("presets.ui.zapret2.preset_detail_page", "Zapret2PresetDetailPage"),
    "Zapret2ProfilesPage": ("profile.ui.profiles_page", "Zapret2ProfilesPage"),
    "Zapret2UserPresetsPage": ("presets.ui.zapret2.user_presets_page", "Zapret2UserPresetsPage"),
    "ProfileDetailPage": ("profile.ui.detail_page", "ProfileDetailPage"),
