# filters/ui/profile_strategy_item.py
"""
Карточка profile для выбора стратегии.

Новая раскладка намеренно разделена на две смысловые зоны:
- слева идентичность profile: иконка, название, inline-метаинформация, badge;
...
class ProfileStrategyItem(CardWidget):
    """
    Карточка profile для выбора стратегии.

    Строка состоит из двух зон:
    - слева смысловая часть profile;
