...
class Zapret1DeferredBuildWidgets:
    profiles_card: object
    open_profiles_btn: object
...
def build_z1_pages_deferred_sections(
    *,
    add_section_title,
    tr_fn,
    content_parent,
    ...
    profiles_card = build_push_setting_card_common(
        ...
        title_text=tr_fn("page.z1_control.profiles.title", "Профили и готовые стратегии"),
        content_text=tr_fn("page.z1_control.profiles.desc", "Выбор профиля и готовой стратегии из выбранного пресета"),
    ...
    return Zapret1DeferredBuildWidgets(
        profiles_card=profiles_card,
        open_profiles_btn=profiles_card.button,
