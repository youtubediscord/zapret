...
class Zapret2DeferredBuildWidgets:
    profile_section_label: object
    profile_card: object
    profiles_open_btn: object
...
def build_z2_pages_deferred_sections(
    *,
    add_section_title,
    tr_fn,
    content_parent,
    ...
    profile_section_label = add_section_title(
        return_widget=True,
        text_key="page.z2_control.section.profile_tuning",
    )

    profile_card = setting_card_group_cls(
        tr_fn("page.z2_control.section.profile_tuning", "Профили"),
        content_parent,
    )
    profiles_open_card = build_push_setting_card_common(
        ...
        title_text=tr_fn("page.z2_control.profile_ui_mode.card.title", "Открыть profiles"),
        content_text=tr_fn("page.z2_control.profile_ui_mode.card.desc", "Перейти к настройке profiles и стратегий"),
        on_click=on_open_profiles_page,
    ...
    profile_ui_mode_card = build_push_setting_card_common(
        ...
        content_text=tr_fn("page.z2_control.profile_ui_mode.caption", "Режим отображения profile"),
    ...
    try:
        ...
        pass
    profile_card.addSettingCard(profiles_open_card)
    ...
    return Zapret2DeferredBuildWidgets(
        ...
        profiles_open_btn=profiles_open_card.button,
