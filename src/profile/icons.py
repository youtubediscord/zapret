...
_KNOWN_ICONS: dict[str, ProfileIconSpec] = {
    ...
    "fastly": ProfileIconSpec("simple:fastly:FS", "#FF282D"),
    "frantech": ProfileIconSpec("fa5s.server", "#F59E0B"),
    "hetzner": ProfileIconSpec("simple:hetzner:HE", "#D50C2D"),
    "novoserve": ProfileIconSpec("fa5s.server", "#2563EB"),
    "ovh": ProfileIconSpec("simple:ovh:OV", "#123F6D"),
    "railway": ProfileIconSpec("fa5s.train", "#A855F7"),
    "warp": ProfileIconSpec("simple:cloudflare:CF", "#F6821F"),
    "worldstream": ProfileIconSpec("fa5s.server", "#0EA5E9"),
